...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url().ASSET_PATH; ?>assets/vendors/owlcarousel/assets/owl.theme.default.min.css">
                        ...
                        <?php if (session()->get('zd_uname')): ?>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="customerDropdown">
                                    <li><a class="dropdown-item" href="<?= base_url('customer/profile') ?>"><i class="bi bi-person-circle"></i> My Profile</a></li>
                                    <li><a class="dropdown-item" href="<?= base_url('logout') ?>"><i class="bi bi-escape"></i> Logout</a></li>
                                </ul>
                            </div>
                        <?php else: ?>
