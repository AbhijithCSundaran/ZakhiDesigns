                        ...
                        <div id="collapseNew" class="accordion-collapse collapse" data-bs-parent="#addressAccordion">
                            <div class="accordion-body">
                                <form id="newAddressForm">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-2"><input type="text" name="newName"
                                                class="form-control" placeholder="Full Name" required></div>
                                        <div class="col-md-6 mb-2"><input type="email" name="newEmail"
                                                class="form-control" placeholder="Email" required></div>
                                        <div class="col-md-6 mb-2 phn_code">
                                            <input type="tel" maxlength="15" name="newPhone" id="newPhone"
                                                class="form-control" placeholder="Phone" required>
                                            <div class="col-md-6 mb-2"><input type="text" name="newBuilding"
                                                    class="form-control" placeholder="Building No" required></div>
                                            <div class="col-md-6 mb-2"><input type="text" name="newStreet"
                                                    class="form-control" placeholder="Street" required></div>
                                            <div class="col-md-6 mb-2"><input type="text" name="newLandmark"
                                                    class="form-control" placeholder="Landmark"></div>
                                            <div class="col-md-6 mb-2"><input type="text" name="newCity"
                                                    class="form-control" placeholder="City" required></div>
                                            <div class="col-md-6 mb-2"><input type="text" name="newState"
                                                    class="form-control" placeholder="State" required
                                                    pattern="[A-Za-z\s]+"
                                                    title="No Numeric Or Special Characters Allowed"></div>
                                            <div class="col-md-6 mb-2"><input type="text" name="newPincode"
                                                    class="form-control" placeholder="Pincode" maxlength="6"
                                                    pattern="[1-9][0-9]{5}" required></div>
                                        </div>
                                        <button type="submit" class="btn btn-primary mt-2">Save & Use This
                                            Address</button>
                                    </div>        
                                </form>
                            </div>
