								...
								<div id="messageBox" class="alert alert-success" style="display: none;"></div>
                                    <form name="createcustaddress" id="createcustaddress" method="post">
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" name="mobile" id="mobile" maxlength="10" minlength="10" autocomplete="off"
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" name="pincode" id="pincode" maxlength="6" minlength="6" autocomplete="off"
										...
										<input type="hidden" name="add_id" value="<?= isset($address['add_Id']) ? esc($address['add_Id']) : '' ?>">
											...
											<button type="button" class="btn btn-secondary" onclick="window.location.href='<?= base_url('customer/location/' .$add_CustId); ?>'">
