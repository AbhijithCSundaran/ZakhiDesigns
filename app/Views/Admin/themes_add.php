									...
									<form name="theme_add" id="theme_add" method="post" enctype="multipart/form-data">
													...
													<div class="card">
														<div class="card-header p-2" style="cursor: pointer;"
															...
															<span class="d-block m-0"
																style="text-decoration: none !important;  font-size: 16px; color: #000 !important;">
															...
															<div class="card-body p-2" id="section1">
																	...
																	<?php if (!empty($banner['theme_Section1'])): ?>
																		<?php foreach ($banner['theme_Section1'] as $entry): ?>
																			<div class="entry form-row align-items-end mb-2">
																				...
																				<div class="col-6">
																					<span>(Image size between 1200×300 and
																						1300×400)</span>
																		...
																		<div class="entry form-row align-items-end mb-2">
																			...
																			<div class="col-6">
																				<span>(Image size between 1200×300 and
																					1300×400)</span>
																				<input type="file" class="form-control"
																					name="section1_image[]" accept="image/*"
																					onchange="previewImage(this)">
																				<input type="hidden"
																					name="section1_image_old[]" value="">
																			</div>
																			<div class="col-12 mt-2">
																				<img class="preview img-thumbnail"
																					style="width: 100px; height: 100px; display: none;">
																...
																<div class="text-end mt-2">
																	<button type="button" class="btn btn-success btn-sm"
																		onclick="addEntry('section1')">+</button>
																</div>
															</div>
														</div>
													</div>
													...
													<div class="card mt-2">
														...
														<div id="sectionTwo" class="collapse"
															...
															<div class="card-body p-2" id="section2">
																	...
																	<?php if (!empty($banner['theme_Section2'])): ?>
																		<?php foreach ($banner['theme_Section2'] as $entry): ?>
																			<div class="entry form-row align-items-end mb-2">
																				...
																				<div class="col-12 mt-2">
																					<span>(Image size between 300*200 and
																						400*300)</span>
																					<input type="file" class="form-control"
																...
																<div class="text-end mt-2">
																	<button type="button" class="btn btn-success btn-sm"
																		onclick="addEntry('section2')">+</button>
																</div>
															</div>
														</div>
													</div>
													...
													<div class="card mt-2">
														...
														<div id="sectionThree" class="collapse"
															...
															<div class="card-body p-2" id="section3">
																	...
																	<?php if (!empty($banner['theme_Section3'])): ?>
																		<?php foreach ($banner['theme_Section3'] as $entry): ?>
																			<div class="entry form-row align-items-end mb-2">
																				...
																				<div class="col-6">
																					<span>(Image size between 1200*400 and
																						1400*500)</span>
																					<input type="file" class="form-control"
																...
																<div class="text-end mt-2">
																	<button type="button" class="btn btn-success btn-sm"
																		onclick="addEntry('section3')">+</button>
																</div>
															</div>
														</div>
													</div>
										...
										<div class="row justify-content-center">
											...
											<div class="button-group">
												...
												<button type="button" class="btn btn-primary" id="main_home_submit"
													name="main_home_submit">
